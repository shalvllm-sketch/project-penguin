...
st.markdown("""
    ...
    /* 1. THE BRILLIANT DYNAMIC BACKGROUND + HEARTS */
    .stApp {
        /* The Moving Gradient */
    ...
    /* Overlay the hearts texture on top of the gradient */
    .stApp::before {
        content: "";
        position: absolute;
        top: 0;
    ...
    /* 2. THE BIG BOUNCING TITLE */
    .title-text {
        font-family: 'Pacifico', cursive;
        font-size: 60px;
        color: white;
        text-align: center;
        /* A cool 3D Pop-out effect */
...
# st.markdown("""
#     <div class="title-box">
#         <p class="title-text">Hey Capybara 🥔</p>
#     </div>
# """, unsafe_allow_html=True)
